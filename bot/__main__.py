...
def start(update, context):
    ...
    buttons.buildbutton("Developer", "https://t.me/DextiN_xD")
    buttons.buildbutton("Channel", "https://t.me/DDBBots")
...
'''
        ...
        sendMarkup(
            'Oops! not a Authorized user.\nPlease deploy your own <b>@NetflixTudum</b>.',
            context.bot,
            update,
            reply_markup,
        )
